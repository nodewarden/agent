...
func ValidateConfig(c *Config) error {
	...
	validator.ValidateURL("server_url", c.ServerURL)
	validator.ValidateLogLevel("log_level", c.LogLevel)
	validator.ValidateDuration("collection_interval", c.CollectionInterval,
...
func (c *Config) SetDefaults() {
	if c.ServerURL == "" {
		c.ServerURL = "https://api.nodewarden.com/agent"
	}
